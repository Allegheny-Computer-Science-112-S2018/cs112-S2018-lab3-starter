...
# cs112-S2018-lab3-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Laboratory 3 in Computer Science 112. Since
...
`Reverser.java` and `TestReverser.java` files must adhere to
...
- `Reverser.java` contains at least four multi-line comments in the JavaDoc standard.
- `TestReverser.java` contains at least six passing test cases.
- `Reverser.java` contains twelve `println`s to produce the twenty-six lines
  of output.
- `Reverser.java` correctly uses the book's method to generically reverse arrays.
...
- `Reverser.java` passes all of the test cases defined in the JUnit test suite.
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-112-S2018/cs112-S2018-lab3-starter.git
```
...
you can go to the [Computer Science 112 Lab 3
Starter](https://github.com/Allegheny-Computer-Science-112-S2018/cs112-S2018-lab3-starter)
